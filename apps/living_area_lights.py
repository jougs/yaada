...
class LivingAreaLights(SceneManager):
    ...
    lights = {
        ...
        "light.dining_room_dining_table_1": {"state": "on", "brightness": 255},
        "light.dining_room_dining_table_2": {"state": "on", "brightness": 255},
        "light.dining_room_dining_table_3": {"state": "on", "brightness": 255},
        "light.dining_room_dining_table_4": {"state": "on", "brightness": 255},
        "light.dining_room_dining_table_5": {"state": "on", "brightness": 255},
    ...
    scenes = {
        "movies": { # 3
            ...
            'replaces': [],
            'lights': {
                "light.dining_room_bar_1": {"state": "off"},
                "light.dining_room_bar_2": {"state": "off"},
                "light.dining_room_bar_3": {"state": "off"},
                "light.dining_room_bar_downlight": {"state": "on", "brightness": 32},
                "light.dining_room_dresser": {"state": "off"},
                "light.dining_room_plant_stand": {"state": "on", "brightness": 64, "rgb_color": (128,96,0)},
                "light.dining_room_dining_table_1": {"state": "off"},
                "light.dining_room_dining_table_2": {"state": "off"},
                "light.dining_room_dining_table_3": {"state": "off"},
                "light.dining_room_dining_table_4": {"state": "off"},
                "light.dining_room_dining_table_5": {"state": "off"},
                "light.kitchen_bar_downlight": {"state": "on", "brightness": 32},
                "light.kitchen_downlight": {"state": "off"},
                "light.kitchen_floor_cabinets": {"state": "on", "brightness": 32},
                "light.kitchen_hob": {"state": "off"},
                "light.kitchen_wall_cabinet": {"state": "on", "brightness": 32},
                "light.living_room_ceiling_west": {"state": "on", "brightness": 64},
                "light.living_room_ceiling_east": {"state": "on", "brightness": 64},
                "light.living_room_corner_shelf": {"state": "off"},
                "light.living_room_fireplace": {"state": "on", "brightness": 32},
                "light.living_room_paper_lamp": {"state": "on", "brightness": 64, "xy_color": (0.491, 0.39)},
                "light.living_room_palm_tree": {"state": "off"},
                "light.pantry_shelf": {"state": "on", "brightness": 32},
                "light.pantry_downlight": {"state": "on", "brightness": 32},
                "light.living_room_recliner": {"state": "off"},
            }
        },
        "cooking": { # 0
            'name': 'cooking',
        ...
        "dining": { # 1
            ...
            'lights': {
                ...
                "light.dining_room_dining_table_1": {"state": "on", "brightness": 64},
                "light.dining_room_dining_table_2": {"state": "on", "brightness": 32},
                "light.dining_room_dining_table_3": {"state": "on", "brightness": 48},
                "light.dining_room_dining_table_4": {"state": "on", "brightness": 64},
                "light.dining_room_dining_table_5": {"state": "on", "brightness": 76},
            }
        },
        "diningfull": { # 1
            'name': 'dining bright',
        ...
        "chillout": { # 3
            'name': 'chillout',
            'icon': 'mdi:sofa',
            'replaces': ['livingfull', "sofadinner"],
            'lights': {
                ...
                "light.living_room_ceiling_east": {"state": "on", "brightness": 96},
        ...
        "sofadinner": { # 3
            ...
            'lights': {
                ...
                "light.kitchen_wall_cabinet": {"state": "on", "brightness": 64},
                "light.dining_room_plant_stand": {"state": "on", "brightness": 64, "rgb_color": (128,96,0)},
                "light.living_room_ceiling_west": {"state": "on", "brightness": 192},
                "light.living_room_ceiling_east": {"state": "on", "brightness": 192},
                "light.living_room_corner_shelf": {"state": "on", "brightness": 128, "rgb_color": (255,128,0)},
                "light.living_room_fireplace": {"state": "on", "brightness": 128},
                "light.living_room_paper_lamp": {"state": "on", "brightness": 79, "xy_color": (0.491, 0.39)},
                "light.living_room_recliner": {"state": "on"},
